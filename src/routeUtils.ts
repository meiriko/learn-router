...
export function validateTab<K extends string, T extends readonly string[]>(
  tabKey: K,
  tabs: T
) {
  return ({
...
export function navigateToDefaultTab(tabKey: string, defaultTab = "default") {
  return (config: {
